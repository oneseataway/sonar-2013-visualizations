 ...
 * All rights reserved.
 *
 * Date: Thu May 16 12:00:26 2013 +0200
 *
 ***
 *
...
var Calculation = this.Calculation = new function() { 
...
var Point = this.Point = Base.extend({
	...
	lerp: function( arg0, arg1, arg2 ) {
		if(typeof arg1 === 'number') {
			this.x = Calculation.lerp(this.x, arg0.x, arg1);
			this.y = Calculation.lerp(this.y, arg0.y, arg1);
			return this;
		}
		else {
			return Point.create(
				Calculation.lerp(arg0.x, arg1.x, arg2),
				Calculation.lerp(arg0.y, arg1.y, arg2)
			);
		}
	},
